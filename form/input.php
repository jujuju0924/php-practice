...
elseif($_POST['age']==='2'){echo '２０歳〜２９歳';}
elseif($_POST['age']==='3'){echo '３０歳〜３９歳';}
elseif($_POST['age']==='4'){echo '４０歳〜４９歳';}
elseif($_POST['age']==='5'){echo '５０歳〜５９歳';}
elseif($_POST['age']==='6'){echo '６０歳〜';}
?>
<br>
お問い合わせ内容
...
<input type="url" class="form-control" name="url" value="<?php echo h($_POST['url']) ; ?>">
</div>
...
<textarea class="form-control" id="contact" row="3" name="contact" value="<?php echo h($_POST['contact']) ; ?>">
</textarea>
</div>
